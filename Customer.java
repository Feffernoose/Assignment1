 ...
 *  is a toString method to override the default method, and the classes are set up as per instructions given.
 */

public class Customer {

	// Data members are set as private to provide abstraction. 
	private String name;
